...
public class TCPClientFile
{
    ...
    public void receiveFile()
    {
        ...
        try
        {
            ...
            FileOutputStream fileOut = new FileOutputStream("3096Mb.txt",true);
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        long singleFinish = new Date().getTime();
        System.out.println("With merging, the time takes " + singleFinish);
    }
}